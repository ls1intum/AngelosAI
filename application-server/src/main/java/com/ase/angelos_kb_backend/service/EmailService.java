...
public class EmailService {
        ...
        String htmlContent = """
            ...
            <body>
                <div class="email-container">
                    <h1>StudiAssist AI - E-Mail Bestätigen</h1>
    ...
    public void sendPasswordResetEmail(String toEmail, String subject, String resetUrl) throws MessagingException {
        MimeMessage mimeMessage = mailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, "UTF-8");
        helper.setTo(toEmail);
        helper.setSubject(subject);
        ...
        String htmlContent = """
            ...
            <head>
                ...
                <style>
                    body { font-family: Arial, sans-serif; background-color: #f4f4f4; color: #072140; margin: 0; padding: 0; }
                    .email-container { background-color: #ffffff; border: 1px solid #ccc; border-radius: 8px; padding: 20px; max-width: 600px; margin: 40px auto; text-align: center; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); }
                    h1 { color: #3070b3; }
                    p { font-size: 14px; margin: 15px 0; }
                    a.button { display: inline-block; margin-top: 20px; padding: 10px 15px; background: #3070b3; color: #ffffff !important; text-decoration: none; border-radius: 4px; font-weight: bold; }
                    a.button:hover { background: #0a2d57; }
                    a.link { color: #3070b3; text-decoration: none; }
